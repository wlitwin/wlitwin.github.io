...
reg("__structural_eq", 2, (args) =>
  vbool(valuesEqual(args[0], args[1])));
reg("__structural_neq", 2, (args) =>
  vbool(!valuesEqual(args[0], args[1])));
reg("__structural_lt", 2, (args) =>
  vbool(valuesCompare(args[0], args[1]) < 0));
